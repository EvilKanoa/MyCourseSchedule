...
class ScheduleView extends PureComponent {
  ...
  onSectionMouseOver = course => id => {
    ...
    if (
      !this.state.prevSelectedSchedule &&
      ...
      this.setState({
        ...
        hightlightSections: [
          fullId,
          _.find(this.props.selectedSections, sectionId =>
            sectionId.startsWith(course)
          ),
        ],
      });
    }
  ...
  eventRenderer = (event, day, events) => (
    <div
      ...
      style={
        this.overlaps(event, events)
          ? {
              backgroundColor: this.getCourseColours(
  ...
  render() {
    ...
    const { searched, prevSelectedSchedule, hightlightSections } = this.state;
          ...
          {_.map(selectedCourses, code => (
            <div className="selected-course" key={code}>
              ...
              <Course
                ...
                key={code}
                titleStyle={{
                  backgroundColor: this.getCourseColours(selectedCourses)[code],
                }}
